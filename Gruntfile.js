module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		options: {
			...
			js: {
				...
				files: ['assets/vendor/jquery/jquery.min.js','assets/vendor/bootstrap-sass-official/vendor/assets/javascripts/bootstrap.js','assets/js/app.js'],							// JavaScript files in order you'd like them concatenated and minified
		...
		copy : {
			main:{
				...
				{expand:true, src:'assets/vendor/alertify.js/dist/**', dest:'public/'}
				]
			}
		},
	...
	// Register tasks
	grunt.registerTask('default', ['clean:all', 'sass',  'concat:css', 'concat:js', 'cssmin', 'uglify', 'clean:concat', 'copy', 'watch']); // Default task
}